...
class RealPreferencesHelper(val context: Context) : PreferencesHelper {
    ...
    companion object {
        const val FAILED_DAYS_KEY = "com.aplikasi.sahabatkamu.FAILED_DAYS_KEY"
        const val GET_UP_DELAY_KEY = "com.aplikasi.sahabatkamu.GET_UP_DELAY_KEY"
        const val SAVED_HOUR_KEY = "com.aplikasi.sahabatkamu.SAVED_HOUR_KEY"
        const val SAVED_MINUTE_KEY = "com.aplikasi.sahabatkamu.SAVED_MINUTE_KEY"
        const val RINGTONE_KEY = "com.aplikasi.sahabatkamu.RINGTONE_KEY"
        const val RINGTONE_TITLE_KEY = "com.aplikasi.sahabatkamu.SAVED_RINGTONE_KEY"
        const val STREAK_KEY = "com.aplikasi.sahabatkamu.STREAK_KEY"
        const val SAVED_VOLUME_KEY = "com.aplikasi.sahabatkamu.SAVED_VOLUME_KEY"
        const val SHARED_PREFS_FILE = "com.aplikasi.sahabatkamu.shared_prefs_file"
        const val STAY_OFF_KEY = "com.aplikasi.sahabatkamu.STAY_OFF_KEY"
        const val SUCCESSFUL_DAYS_KEY = "com.aplikasi.sahabatkamu.SUCCESSFUL_DAYS_KEY"
        const val SNOOZE_DURATION_KEY = "com.aplikasi.sahabatkamu.SNOOZE_DURATION_KEY"
        const val DARK_MODE_KEY = "com.aplikasi.sahabatkamu.DARK_MODE_KEY"
        const val FIRST_DAY_OF_WEEK_KEY = "com.aplikasi.sahabatkamu.FIRST_DAY_OF_WEEK_KEY"
        const val PM_CONFIRM_KEY = "com.aplikasi.sahabatkamu.PM_CONFIRM_KEY"
    }
}